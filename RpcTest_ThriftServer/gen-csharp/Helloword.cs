...
public partial class Helloword {
  ...
  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_SayHello(AsyncCallback callback, object state, HelloRequest request);
    HelloReply End_SayHello(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : IDisposable, Iface {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_SayHello(AsyncCallback callback, object state, HelloRequest request)
    {
      return send_SayHello(callback, state, request);
    }

    public HelloReply End_SayHello(IAsyncResult asyncResult)
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult send_SayHello(AsyncCallback callback, object state, HelloRequest request)
    #else
    public void send_SayHello(HelloRequest request)
    #endif
    {
    ...
    public HelloReply recv_SayHello()
    {
  ...
  {
    private HelloReply _success;

    public HelloReply Success
    {
      get
      {
        return _success;
